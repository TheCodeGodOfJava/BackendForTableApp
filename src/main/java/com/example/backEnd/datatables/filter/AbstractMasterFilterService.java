...
public abstract class AbstractMasterFilterService<T> {
    ...
    public AbstractMasterFilterService(
        ...
        this.filterService = new BaseFilterService<>(entityPath, entityManager, dependencyPath, entityJoins);
    }
    ...
    public Collection<?> findByFieldAndTerm(String field, String term, String dep, BooleanExpression exp) {
        return filterService.findByFieldAndTerm(field, term, dep, exp);
    }

    public Collection<?> findByFieldAndTerm(Long masterId, String masterType, String field, String term, String dep) {
